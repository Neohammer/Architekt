...
{if $APPLICATION_USER}#[Setting('multi', 'Enable multiple accounts on app', 'bool', false)]{/if}
class UserController extends AdminController implements UserControllerInterface
{
